...
const DETAIL_FIELDS: Record<string, { title: string; fields: DetailField[] }> = {
  ...
  窗口出租: {
    title: '出租详情',
    fields: [
      { key: 'mainBiz', label: '主营项目', placeholder: '例：快餐炒菜', maxLength: 30 },
      { key: 'intentArea', label: '意向地区', placeholder: '例：青岛大学周边', maxLength: 30 },
    ],
  },
  摊位招租: {
    title: '出租详情',
  ...
  商铺转让: {
    ...
    fields: [
      { key: 'school', label: '学校名称', placeholder: '例：青岛大学', maxLength: 20 },
      { key: 'students', label: '在校人数', placeholder: '例：在校生20000人', maxLength: 20 },
      { key: 'area', label: '面积大小', placeholder: '例：80㎡', maxLength: 20 },
      { key: 'floor', label: '所在楼层', placeholder: '例：一楼餐厅二层', maxLength: 10 },
    ],
  },
  柜台招商: {
    ...
    fields: [
      { key: 'school', label: '学校名称', placeholder: '例：青岛大学', maxLength: 20 },
      { key: 'students', label: '在校人数', placeholder: '例：在校生20000人', maxLength: 20 },
      { key: 'floor', label: '商铺楼层', placeholder: '例：一楼餐厅二层', maxLength: 10 },
      { key: 'shopArea', label: '商铺面积', placeholder: '例：80㎡', maxLength: 20 },
    ],
  },
  广告位招租: {
  ...
  'hospital/档口招商': {
    title: '档口详情',
    fields: [
      { key: 'hospital', label: '医院名称', placeholder: '例：青岛市中心医院', maxLength: 20 },
      { key: 'diners', label: '用餐人数', placeholder: '例：日均用餐5000人', maxLength: 20 },
      { key: 'floor', label: '所在楼层', placeholder: '例：一楼餐厅二层', maxLength: 10 },
      { key: 'feeMode', label: '收费模式', placeholder: '例：租金+扣点', maxLength: 20 },
      { key: 'contractTime', label: '合同时间', placeholder: '例：3年', maxLength: 20 },
      { key: 'dailyRevenue', label: '日均营业额', placeholder: '例：单个档口3000元', maxLength: 20 },
  ...
  default: {
    ...
    fields: [
      { key: 'school', label: '学校名称', placeholder: '例：青岛大学', maxLength: 20 },
      { key: 'students', label: '在校人数', placeholder: '例：在校生20000人', inputMode: 'numeric', filter: 'int', suffix: '人', maxLength: 7 },
      { key: 'floor', label: '商铺楼层', placeholder: '例：一楼餐厅二层', maxLength: 10 },
